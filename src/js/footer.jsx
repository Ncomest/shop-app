  ...
  <div style={styles.footContainer}>
   ...
   <div style={styles.footBlock}>
    ...
    <div>
     ...
     <p style={styles.cursorPointer}>About</p>
     <p style={styles.cursorPointer}>Delivery information</p>
     <p style={styles.cursorPointer}>Privacy Policy</p>
     <p style={styles.cursorPointer}>Sales</p>
     <p style={styles.cursorPointer}>Terms & Conditions </p>
     <p style={styles.cursorPointer}>EMI Payment</p>
    </div>
    <div>
     <h5 style={styles.Footh5}>ACCOUNT</h5>
     <p style={styles.cursorPointer}>My Account</p>
     <p style={styles.cursorPointer}>My Orders</p>
     <p style={styles.cursorPointer}>Returns</p>
     <p style={styles.cursorPointer}>Shipping</p>
     <p style={styles.cursorPointer}>Wishlist</p>
     <p style={styles.cursorPointer}>Account Details</p>
    </div>
    <div>
     <h5 style={styles.Footh5}>Store</h5>
     <p style={styles.cursorPointer}>Affiliate</p>
     <p style={styles.cursorPointer}>Discounts</p>
     <p style={styles.cursorPointer}>Sale</p>
     <p style={styles.cursorPointer}>Contact</p>
     <p style={styles.cursorPointer}>All Collections</p>
    </div>
    <div>
     <h5 style={styles.Footh5}>CONTACT US</h5>
     <p style={styles.contWidth}>
      If you have any query, please contact us{" "}
      <span style={{ ...styles.cursorPointer, ...styles.colorMail }}>
       needus24@gmail.com
      </span>
     </p>
     ...
     <div style={styles.flex}>
      ...
      <p style={styles.cursorPointer}>+12012987481</p>
     </div>
    </div>
   </div>
   <div>
